...
st.markdown(
    ...
    <div style="text-align: center; background: {background_color}; padding: 20px; border-radius: 15px;">
        <h1 style="color: {text_color}; font-size: 3em;">Flower Power 🌼</h1>
        <p style="font-size: 1.2em; color: #555;">Upload a flower image </p>
...
if page == "Home":
    ...
    if uploaded_file is not None:
        try:
            # format compatible with PIL
            image = Image.open(uploaded_file)

            # Displaing the uploaded 
